...
public class CustomProductConstants {

    public static final String DATA_MODIFIED = "Date modificate cu succes!";
    public static final String CUSTOM_PRODUCT_DELETED = "Buchetul a fost șters cu succes.";
    public static final String CUSTOM_PRODUCT_CREATED = "Buchetul a fost creat cu succes!";
